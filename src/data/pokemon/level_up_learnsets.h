...
static const u16 sGranbullLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(51, MOVE_SMELLING_SALT),
...
static const u16 sCelebiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(73, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(82, MOVE_SYNTHESIS),
