...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    .moves = {MOVE_SANDSTORM, MOVE_MUD_SLAP, MOVE_SAND_ATTACK, MOVE_GUST}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty3[] = {
    ...
    .lvl = 30,
    .species = SPECIES_TRAPINCH,
    .moves = {MOVE_SANDSTORM, MOVE_MUD_SLAP, MOVE_SAND_ATTACK, MOVE_FAINT_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty4[] = {
    ...
    .moves = {MOVE_SANDSTORM, MOVE_MUD_SLAP, MOVE_DIG, MOVE_FAINT_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty5[] = {
    ...
    .lvl = 36,
    .species = SPECIES_VIBRAVA,
    .moves = {MOVE_SANDSTORM, MOVE_MUD_SLAP, MOVE_DRAGON_BREATH, MOVE_FAINT_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky1[] = {
    ...
    .lvl = 13,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_SAND_ATTACK, MOVE_HEADBUTT, MOVE_TAIL_WHIP, MOVE_CUT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky2[] = {
    ...
    .lvl = 27,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_PIN_MISSILE, MOVE_TAIL_WHIP, MOVE_ROCK_SMASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_AGILITY, MOVE_WING_ATTACK, MOVE_FEATHER_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOLLOW_ME, MOVE_NATURE_POWER, MOVE_METRONOME, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .species = SPECIES_TOGETIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENCORE, MOVE_WISH, MOVE_METRONOME, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEADBUTT, MOVE_GLARE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_PURSUIT, MOVE_NONE, MOVE_NONE}
    }};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = {
    ...
    .species = SPECIES_PERSIAN,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_PAY_DAY, MOVE_ASSIST, MOVE_QUICK_ATTACK, MOVE_FURY_SWIPES}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winston5[] = {
    ...
    .species = SPECIES_FURRET,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_FURY_SWIPES, MOVE_SURF, MOVE_ODOR_SLEUTH, MOVE_SAND_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .moves = {MOVE_DIG, MOVE_SAND_ATTACK, MOVE_POISON_STING, MOVE_FURY_SWIPES}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Edward[] = {
    ...
    .moves = {MOVE_HIDDEN_POWER, MOVE_FLASH, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 15,
    .species = SPECIES_RALTS,
    .moves = {MOVE_HIDDEN_POWER, MOVE_GROWL, MOVE_CONFUSION, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter3[] = {
    ...
    .moves = {MOVE_THUNDER_SHOCK, MOVE_COTTON_SPORE, MOVE_CONFUSE_RAY, MOVE_ZAP_CANNON}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TORMENT, MOVE_RAZOR_LEAF, MOVE_SWAGGER, MOVE_EXTRASENSORY}
    },
    {
    .iv = 250,
    .lvl = 46,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_CONFUSE_RAY, MOVE_SLUDGE_BOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENCORE, MOVE_BODY_SLAM, MOVE_HAIL, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Colton[] = {
    ...
    .species = SPECIES_SKITTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ASSIST, MOVE_CHARM, MOVE_WATER_PULSE, MOVE_HEAL_BELL}
    },
    {
    .iv = 0,
    .lvl = 40,
    .species = SPECIES_SKITTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ASSIST, MOVE_CHARM, MOVE_ICE_BEAM, MOVE_HEAL_BELL}
    },
    {
    .iv = 0,
    .lvl = 12,
    .species = SPECIES_SKITTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ASSIST, MOVE_CHARM, MOVE_THUNDERBOLT, MOVE_HEAL_BELL}
    },
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_SKITTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ASSIST, MOVE_CHARM, MOVE_IRON_TAIL, MOVE_HEAL_BELL}
    },
    {
    .iv = 0,
    .lvl = 42,
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ASSIST, MOVE_CHARM, MOVE_SECRET_POWER, MOVE_HEAL_BELL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Aaron[] = {
    ...
    .moves = {MOVE_DRAGON_BREATH, MOVE_SLAM, MOVE_WHIRLPOOL, MOVE_TWISTER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao2[] = {
    ...
    .lvl = 24,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_POISON_GAS, MOVE_TACKLE, MOVE_SLUDGE, MOVE_PROTECT}
    },
    {
    .iv = 0,
    .lvl = 24,
    ...
    .lvl = 26,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TACKLE, MOVE_SLUDGE, MOVE_PROTECT, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao3[] = {
    ...
    .lvl = 27,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_POISON_GAS, MOVE_PROTECT, MOVE_SLUDGE, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 20,
    .lvl = 27,
    ...
    .lvl = 29,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TACKLE, MOVE_SLUDGE, MOVE_NONE, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    .lvl = 19,
    .species = SPECIES_HOPPIP,
    .moves = {MOVE_RAZOR_LEAF, MOVE_GUST, MOVE_MEGA_DRAIN, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Angelica[] = {
    ...
    .lvl = 30,
    .species = SPECIES_CHINCHOU,
    .moves = {MOVE_RAIN_DANCE, MOVE_SURF, MOVE_THUNDER, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline3[] = {
    ...
    .lvl = 32,
    .species = SPECIES_JUMPLUFF,
    .moves = {MOVE_SOLAR_BEAM, MOVE_GUST, MOVE_MEGA_DRAIN, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline4[] = {
    ...
    .lvl = 34,
    .species = SPECIES_JUMPLUFF,
    .moves = {MOVE_SOLAR_BEAM, MOVE_GUST, MOVE_SYNTHESIS, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kayley[] = {
    ...
    .lvl = 31,
    .species = SPECIES_HOUNDOUR,
    .moves = {MOVE_SUNNY_DAY, MOVE_CRUNCH, MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .lvl = 23,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_SHOCK_WAVE, MOVE_FURY_SWIPES, MOVE_FAINT_ATTACK, MOVE_BIND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR2[] = {
    ...
    .moves = {MOVE_BLIZZARD, MOVE_ICY_WIND, MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 150,
    .lvl = 46,
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .lvl = 30,
    .species = SPECIES_CHINCHOU,
    .moves = {MOVE_THUNDER, MOVE_RAIN_DANCE, MOVE_THUNDER_WAVE, MOVE_NONE}
    }
};
